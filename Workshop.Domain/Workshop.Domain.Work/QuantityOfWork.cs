...
namespace Workshop.Domain.Work
{
    public class QuantityOfWork : IEquatable<QuantityOfWork>
    {
        ...
        public static QuantityOfWork operator +(QuantityOfWork first, QuantityOfWork second)
            => new QuantityOfWork(first._value + second._value);

        public static float operator /(QuantityOfWork completed, QuantityOfWork total)
            => completed._value / total._value;

        public static bool operator <(QuantityOfWork first, QuantityOfWork second)
